...
## [2.50.0](https://github.com/pybashc/comet/compare/v2.49.0...v2.50.0) (2026-02-05)


### Features

* add `tzdata` package and set `TZ` environment variable to `UTC` ([29ac052](https://github.com/pybashc/comet/commit/29ac0525a55943612a4e3521acd843ddb7e00f71))
* add COMET_CLEAN_TRACKER setting to control tracker list display in Comet scraper ([a35327b](https://github.com/pybashc/comet/commit/a35327b111b8459926c7c8e3751e2388e16bf0e0))
* add configurable reachability check settings including retries, delay, and timeout for improved connection handling ([16f5df4](https://github.com/pybashc/comet/commit/16f5df4bceb1d2e77286a913eb27f543b62ab25d))
* add debug logging to `_validate_torrent` for various torrent validation failure conditions ([bde663f](https://github.com/pybashc/comet/commit/bde663f48ad406f9d3e8a3f6de1ae88744d0c157))
* add DMM to supported scrapers and introduce DMM Ingester feature ([68fa89d](https://github.com/pybashc/comet/commit/68fa89de2dbb4ab8c7950b8a6cd51dc4308d34e2))
* add external reachability check for COMETNET_ADVERTISE_URL and introduce COMETNET_SKIP_REACHABILITY_CHECK for local testing ([f8983c7](https://github.com/pybashc/comet/commit/f8983c73970eec309476eef4afd8b48bf3657d09))
* add HTTP request handling to the WebSocket server for graceful responses to non-WebSocket requests ([4b0a187](https://github.com/pybashc/comet/commit/4b0a18738b364550500478d379f9f393529f193b))
* add local torrent existence check to optimize gossip validation and enhance message re-propagation ([8e04047](https://github.com/pybashc/comet/commit/8e04047c58b80791a74e448184427582206bbbea))
* add logging for incoming connection handling in ConnectionManager to track extracted IPs ([fe23a34](https://github.com/pybashc/comet/commit/fe23a34511e093d959a8ff1c807bea1aba4898e5))
* add max latency configuration and handling in CometNet to disconnect peers exceeding acceptable latency, enhancing network performance ([39b5e1b](https://github.com/pybashc/comet/commit/39b5e1b327c593bc2453824c798a7f19e7c33074))
* add optional node alias to CometNet ([9af324f](https://github.com/pybashc/comet/commit/9af324fc9b44d9435f328e966febfe779e7b8f24))
* add periodic state save functionality to CometNetService with configurable interval ([a209467](https://github.com/pybashc/comet/commit/a2094671d90c5c5c9d4422b5d6c8fc8ebfc14634))
* add persistence for the gossip engine's statistics ([8e71ee2](https://github.com/pybashc/comet/commit/8e71ee2ffa4cf86e5cf10aa7a1198200c745a70a))
* add PostgreSQL-specific logic for refreshing scrape locks using `RETURNING 1` to confirm update success ([dd8f8de](https://github.com/pybashc/comet/commit/dd8f8de42a1c8963542d9cf35f70064c6df42ee0))
* add support for cached availability checks across multiple services ([228cba0](https://github.com/pybashc/comet/commit/228cba0554509fa90068a02fa764f079a8b4266f))
* add version information display and update checking functionality to the admin dashboard ([d8c7aa8](https://github.com/pybashc/comet/commit/d8c7aa8c1395c2f96d256d215964ed8c1a5cbd69))
* allow `_scrape_media_type` to signal early termination and stop the scraping loop ([b96fd1f](https://github.com/pybashc/comet/commit/b96fd1f3de710d2ba70549d1a38f28cd16b5e64b))
* apply reputation penalty when an invalid hex signature is encountered ([e23d630](https://github.com/pybashc/comet/commit/e23d63031dd25baf89b0a8c6fa950cf29a5972ac))
* asynchronously validate manifests and canonicalize float values for signature stability, while improving shutdown handling and error logging ([67083f2](https://github.com/pybashc/comet/commit/67083f22e0214e31e4252c89c80d5192b2af24e1))
* cache public key representations, validate incoming info hashes, and generalize message sending to support raw bytes ([6d74cef](https://github.com/pybashc/comet/commit/6d74cef8243dd8117b5ed56bd59ed8e9bd0430b8))
* canonicalize pool manifest timestamps to integers for signing to resolve float precision issues ([67240ad](https://github.com/pybashc/comet/commit/67240adec810ee49afd6dcf2a3043b0aecd908c4))
* derive `node_id` from public key for `PoolMember` and update admin dashboard to display node IDs ([bcd1b14](https://github.com/pybashc/comet/commit/bcd1b1478ba9466465913b304962cefcc45d3d1a))
* display current branch in the admin dashboard version information and visually refresh the version details section ([4b8ad5f](https://github.com/pybashc/comet/commit/4b8ad5fe85a4930f5fb5ef1147f47e8ada52c1e5))
* display peer torrents received in the admin dashboard and include reputation data in peer information ([1be6218](https://github.com/pybashc/comet/commit/1be62185a2b24c8b40e67253a0903c4626bc6f03))
* document CometNet P2P network and remove Nginx reverse proxy configuration from README ([f66c0f2](https://github.com/pybashc/comet/commit/f66c0f22ea836244fc2b629c951622a769b396e5))
* enable standalone CometNet service to directly save discovered torrents to the database ([9caab14](https://github.com/pybashc/comet/commit/9caab14a1b4ab31c8c566a0903000d501760d8b0))
* enhance client IP retrieval in CometNetService by adding support for WebSocket requests ([b9f3dfa](https://github.com/pybashc/comet/commit/b9f3dfa8f30ddaed9d67d2dcf187291bfaa086db))
* enhance COMETNET_ADVERTISE_URL validation with security checks for internal domains, private IPs, and port range, and improve reachability checks for public IPs ([2da0020](https://github.com/pybashc/comet/commit/2da00206b4eb1a52642b0c295c5a0d519e1c712d))
* enhance copyInviteLink function to use async clipboard API with fallback for insecure contexts ([cce81ec](https://github.com/pybashc/comet/commit/cce81ecd9f70712d949690fc84a605960fa813cf))
* enhance cryptographic verification by adding public key loading and signature verification methods ([5e0afc0](https://github.com/pybashc/comet/commit/5e0afc0d25411497c1276350844b07584fb5a603))
* enhance debrid service to enrich torrent metadata from availability checks ([1699808](https://github.com/pybashc/comet/commit/1699808b479501a7dfc5bcfc00a982452c11b992))
* enhance DebridService with file index coercion and parsed data merging ([fe63e77](https://github.com/pybashc/comet/commit/fe63e772d7d75cbe4ac8a497105f854991ef3c60))
* enhance gossip statistics by adding repropagation tracking and updating dashboard labels ([80cc495](https://github.com/pybashc/comet/commit/80cc4954989fc9a201a91a986cc9697352eb8653))
* enhance handshake logging in ConnectionManager for better debugging and error tracking ([454817e](https://github.com/pybashc/comet/commit/454817e4b4c3c7e7c8e7a6238b637bc13d97f420))
* enhance info hash normalization with error handling and new format support ([6b9b33d](https://github.com/pybashc/comet/commit/6b9b33d0325a13f92c5f05d5ce69ea701fe92f66))
* enhance reachability check logic in `check_advertise_url_reachability` to handle hairpin NAT scenarios and improve logging for verification results ([20226ae](https://github.com/pybashc/comet/commit/20226aed5acfabc9fe0b70d6c9b996abfe3f0bf0))
* enhance state loading to tolerate integrity hash mismatches ([1fe70be](https://github.com/pybashc/comet/commit/1fe70be76d8018be94b920f60d36b3470448841d))
* enhance system clock synchronization check to use multiple endpoints and provide detailed error reporting ([9f51226](https://github.com/pybashc/comet/commit/9f51226dd45dd5b09b4444cd0057272a11ada6aa))
* enhance WebSocket connection and handshake logging in ConnectionManager to improve debugging and error tracking ([35f32d6](https://github.com/pybashc/comet/commit/35f32d674aa4e8a8e49f9583d7f25a85d64a1020))
* enhance WebSocket connection logging in CometNetService for improved client IP tracking ([979a26e](https://github.com/pybashc/comet/commit/979a26edd797584b756761f255c8041dc59852bb))
* implement and integrate pool member contribution tracking within the PoolStore and record contributions during gossip processing ([f67b941](https://github.com/pybashc/comet/commit/f67b9419992acc6aa89fee05a3ca2cb0e708d870))
* implement concurrent lock maintenance as a separate task to ensure continuous scraping and robustly handle lock loss ([1172adf](https://github.com/pybashc/comet/commit/1172adf25896cda2db2157079f928b4caa266fe5))
* implement dedicated crypto executor management in utils and shutdown procedure in CometNetService to enhance resource handling ([a944efc](https://github.com/pybashc/comet/commit/a944efc9c1b7bc26b896f3d38e2b7c83b5f7d4a1))
* implement distributed locking for the background scraper and remove the `background_scraper_progress` table ([1b9d8e1](https://github.com/pybashc/comet/commit/1b9d8e1ac4850b47d159d77f6dbfda95919b0c3d))
* implement functionality for users to leave CometNet pools with role-based restrictions ([4081d11](https://github.com/pybashc/comet/commit/4081d1147736f4573984c7e5e013284f14ec97d6))
* implement mandatory and auto-generated `COMETNET_API_KEY`, and add auto-generation for `ADMIN_DASHBOARD_PASSWORD` and `PROXY_DEBRID_STREAM_PASSWORD` ([29a8a5a](https://github.com/pybashc/comet/commit/29a8a5a04decc3f291524140d2308425b8557b03))
* implement membership reconciliation in CometNetService and improve error logging in CometNetRelay ([6cca3f4](https://github.com/pybashc/comet/commit/6cca3f4ac1c38499c07df9bcbe100293770322b9))
* implement message rate limiting and refactor message security validation into a dedicated module ([0a75780](https://github.com/pybashc/comet/commit/0a7578009dc7bb1a864726fa9b786556531f4d23))
* implement new pools management UI with filtering and search functionality in admin dashboard ([12c4695](https://github.com/pybashc/comet/commit/12c46955dae25216d533089d0fdfea4e9e340d9a))
* implement private network mode with HMAC authentication, status display, and enhanced logging ([e154fc0](https://github.com/pybashc/comet/commit/e154fc0deb482912415a69d9114fa431ce340ec0))
* implement proactive distributed lock refreshing and add error handling for background tasks ([c170fc6](https://github.com/pybashc/comet/commit/c170fc68a0ae35befd7408d3149c5a7a02f3d483))
* implement seadex scraper and fix anime media id parser ([436de99](https://github.com/pybashc/comet/commit/436de999f9ef25de8e804af7363e7d6fdb78a648))
* implement self-removal from pools by broadcasting a signed leave message and updating local cleanup logic ([db15cd7](https://github.com/pybashc/comet/commit/db15cd72cc0bf878b6da9625d8c73c9ce5ec3ee2))
* implement sharded and deduplicated filter parse cache ([fab96ae](https://github.com/pybashc/comet/commit/fab96ae3a48af71f2d9ab4627475586e14971f27))
* implement system clock synchronization check on CometNet startup with configurable tolerance and timeout ([51a81e4](https://github.com/pybashc/comet/commit/51a81e49d38d93aa2cfdd5507b908d31f0902625))
* improve client IP extraction in WebSocket connections by introducing get_client_ip_any function and updating connection handling in CometNetService and ConnectionManager ([f2f5838](https://github.com/pybashc/comet/commit/f2f58389ff1ce7e6f42b1bdc24fa04acb52182b4))
* improve connection handling in ConnectionManager by closing duplicate connections and reusing existing ones ([bd0a5f4](https://github.com/pybashc/comet/commit/bd0a5f465bee3720b10db3c9c17659bdcdabf9b0))
* improve data canonicalization by sorting visited nodes and robustly handling dictionary keys, and add debug logging for signature verification ([2c8b3f7](https://github.com/pybashc/comet/commit/2c8b3f716d540324e088793986dd6e998a1a88d2))
* improve error handling in torrent title parsing ([85fc456](https://github.com/pybashc/comet/commit/85fc4566c845ea0bd2f4e52fa9ebe3d5cad3d963))
* improve error handling in torrent title parsing ([42a93d4](https://github.com/pybashc/comet/commit/42a93d4c22df5926f448ff9eadea5b828a2a1418))
* increase default relay timeout and add specific handling for `asyncio.TimeoutError` during batch sends ([f8819b1](https://github.com/pybashc/comet/commit/f8819b1c1763869623b4cb7a6b38ebd9cd1dd3e3))
* init cometnet ([748249e](https://github.com/pybashc/comet/commit/748249e647f58c9bf37c1d069c44802d7a4d5ed7))
* introduce a dirty manifest tracking mechanism and `flush_dirty_manifests` method to batch manifest writes ([b37ec8a](https://github.com/pybashc/comet/commit/b37ec8a2befa921fe62107d4dc18b262d7ec7ebb))
* Introduce DMM ingester ([19001ee](https://github.com/pybashc/comet/commit/19001eeb6b4f6b45e14880a998a2a6ed19df5200))
* introduce smart language detection by leveraging country-specific Trakt aliases ([c413428](https://github.com/pybashc/comet/commit/c4134289e80385b839a22df18c724b7c83369738))
* log private addresses announced by incoming peers and add a setting to prevent sharing private IPs during PEX ([7160406](https://github.com/pybashc/comet/commit/71604060c8ad54e9ea998ace90facb3311b7559e))
* log specific timeout warnings for scraper exceptions instead of general ratelimiting messages. ([311bfae](https://github.com/pybashc/comet/commit/311bfaee844a51e184d3a99f8fd0c44ab39b57b9))
* nekobt scraper ([da28fc4](https://github.com/pybashc/comet/commit/da28fc4e5c4c5ae5727b73db73b9e6b5bb0a8f0f))
* record own contributions ([a36a9d1](https://github.com/pybashc/comet/commit/a36a9d19efff9e93e909306f999b224e5602f06e))
* refactor HTTP client management and enhance caching mechanisms ([4178cda](https://github.com/pybashc/comet/commit/4178cda8b538641605ef91740e7c524acead6c4e))
* refactor HTTP client management and enhance caching mechanisms ([efca5db](https://github.com/pybashc/comet/commit/efca5dbfded727e02a5f335ad8e6941151949f3c))
* relax connection limits and overrepresentation checks for private IP addresses ([a8cefbd](https://github.com/pybashc/comet/commit/a8cefbd66ec0cf79dec5f6585f8844ac1059e053))
* seadex anime only ([e15125a](https://github.com/pybashc/comet/commit/e15125a339b27a7f3c976b6dd140c5da99c41483))
* seadex anime only ([9b36762](https://github.com/pybashc/comet/commit/9b36762c5ac4d5582b7026631a5f175b8a5a67c0))
* standardize database conflict handling and type checks with new constants, and add cometnet torrent existence batch check callback ([f8e76e9](https://github.com/pybashc/comet/commit/f8e76e9b1832f23369e2905b5a7c19d52c7fed64))
* update canonicalization to preserve float precision and add signature verification debug logs ([f1e871e](https://github.com/pybashc/comet/commit/f1e871e8abcb2d5542ab07a5bc81d9300e1ad516))
* version and update checker ([7c9842a](https://github.com/pybashc/comet/commit/7c9842a937ab117c02913141bd24d9a09c211a83))


### Bug Fixes

* `_save_manifest_async` now returns a boolean, allowing `flush_dirty_manifests` to re-queue failed manifest saves ([cfb648a](https://github.com/pybashc/comet/commit/cfb648a06cd99c30aaaf1f3be6721ac410a7a687))
* broaden WebSocket noise error filtering ([47b4657](https://github.com/pybashc/comet/commit/47b465729b3922cb261082674d8e8e9804d21ca6))
* cinemata no releaseInfo ([5f1ca3e](https://github.com/pybashc/comet/commit/5f1ca3ea53a657567b7dd04e30fd8a5f167437cc))
* D ([721fa0f](https://github.com/pybashc/comet/commit/721fa0fcffe9c289594d4e02d2e86f4f2772edb0))
* default `name_query` parameter to an empty string instead of `None` ([49a7302](https://github.com/pybashc/comet/commit/49a7302066d6f470a5b5efa8a7b62d702bf07971))
* **docker:** add make to build dependencies for miniupnpc ([2fcb2ef](https://github.com/pybashc/comet/commit/2fcb2ef4b82d58fdf59087354124578ea9d1643f))
* **docker:** increase uv timeout to 300s to avoid network errors ([dc98727](https://github.com/pybashc/comet/commit/dc987272af34f939db0f11a8f2a28129907f7927))
* ensure proper lock refresh handling and add read timeout for DMM hashlist downloads. ([bbf2639](https://github.com/pybashc/comet/commit/bbf2639ca6c34aeafdd3e6b25e356c56f0aff52b))
* ensure proper shutdown and tracking of relay batch flush tasks and reorder README features ([53b9c61](https://github.com/pybashc/comet/commit/53b9c61b277548e095bd4a6934aee2b1119020da))
* ensure TorrentMetadata size is an integer and sort pool members by public key for deterministic serialization ([5fe3307](https://github.com/pybashc/comet/commit/5fe330795582ff37607421d89fdf57d014dc7970))
* exclude subscribed and member pools from the discover count calculation ([37e7e6f](https://github.com/pybashc/comet/commit/37e7e6f5c1dd07c21eea9e6b21d8dcaf4d4954c1))
* filter private IPs from PEX and warn on misconfiguration ([7ee5b20](https://github.com/pybashc/comet/commit/7ee5b208c61a54dd9ab43d89868f528ab8212c5b))
* first search emptying itself when torrent cache ttl is -1 ([9237b8c](https://github.com/pybashc/comet/commit/9237b8c7065f77500a5486311a2495ac96bb7dd7))
* fix various memory leaks ([3798971](https://github.com/pybashc/comet/commit/37989716c5388c0acdfd0dfc204e87ae0587d907))
* fix volume on official docker compose ([820ebf0](https://github.com/pybashc/comet/commit/820ebf0ae3d1f577add6fb8ff48df122f66d647f))
* gracefully cancel and drain in-flight scraping tasks upon lock loss instead of abruptly stopping ([2268e8f](https://github.com/pybashc/comet/commit/2268e8f106fb7fd2c77d4adfd34134cb01ffb7f4))
* gracefully handle UnicodeEncodeError during filename processing in DMM ingester ([6e68a93](https://github.com/pybashc/comet/commit/6e68a9398460fe9cedc2494148d91f67769de3d9))
* improve error handling for WebSocket connections with detailed logging ([1c536c8](https://github.com/pybashc/comet/commit/1c536c8b126b513762433d55618aee11e9fdf8d6))
* pool join ([c09a143](https://github.com/pybashc/comet/commit/c09a14374c815405d0e1f044844499398f1abb73))
* postgres ([11aef0f](https://github.com/pybashc/comet/commit/11aef0f98525e1f05fd22010077d16a6abc8be22))
* potential race can drop queued broadcasts during timeout shutdown ([92aadf3](https://github.com/pybashc/comet/commit/92aadf32daf531b6cf418ce6b1962883e3ae9f3c))
* prevent CometNet from starting with multiple FastAPI workers in non-relay mode ([a76a36a](https://github.com/pybashc/comet/commit/a76a36acc11d51d03917debd627073a414758c0e))
* prevent CometNet startup with private advertise URLs on public networks unless explicitly allowed ([e6c8a4c](https://github.com/pybashc/comet/commit/e6c8a4c57a6c2d39b3dcd47fc3725668e857ad63))
* print full traceback for exceptions occurring during the scraping cycle ([0bf3390](https://github.com/pybashc/comet/commit/0bf3390dfe55564e73b8bf66ab22d7c5613507d4))
* remove `OR_IGNORE` from the `first_searches` INSERT statement ([390b452](https://github.com/pybashc/comet/commit/390b45223870954aa1ab63832fef8461407450eb))
* remove ellipsis from truncated node ID displays in the admin dashboard ([96e333d](https://github.com/pybashc/comet/commit/96e333d01960442d5671010d5559c6133a5fc488))
* remove signal handler ([bad47c4](https://github.com/pybashc/comet/commit/bad47c45030206329805d41a8f6127608ab57c55))
* remove the update check interval and related logic to always perform an update check ([9327826](https://github.com/pybashc/comet/commit/9327826ed497b8678a9989942352ef2955cad92d))
* suppress unsupported HTTP method HEAD errors from websockets logs using a new filter ([de4cd80](https://github.com/pybashc/comet/commit/de4cd808ba202d9b6123010f2b76ad9e8bab3cd2))
* update contribution recording logic in `PoolStore` to allow contributions to be recorded across all pools if no specific pool ID is provided, enhancing flexibility in member contribution tracking ([2887a22](https://github.com/pybashc/comet/commit/2887a223b995f40d6017412dc2dce09535c76f94))


### Performance Improvements

* convert key network discovery and cryptographic operations to asynchronous to prevent event loop blocking ([73af287](https://github.com/pybashc/comet/commit/73af2875f2e49e64918cddc5bf49cdd5caf29926))
* offload CPU-bound cryptographic operations to an executor, optimize torrent batch processing, and cache public key data ([6a9f9fd](https://github.com/pybashc/comet/commit/6a9f9fdf2d16e0a4e91dd5ecb03670db29a52dcf))
* remove torrent debrid service short-circuit ([04386ed](https://github.com/pybashc/comet/commit/04386ed619036842e47ce2b3140d3eff198523ca))
